...
namespace LibraryManagementSystem.Data.Datasets.libraryDataSet1TableAdapters
{
...
SELECT authorId, name, surname FROM authors WHERE (authorId = @authorId)";
		...
		public virtual int Fill(libraryDataSet1.authorsDataTable dataTable)
		{
		...
		public virtual libraryDataSet1.authorsDataTable GetData()
		{
			this.Adapter.SelectCommand = this.CommandCollection[0];
			libraryDataSet1.authorsDataTable dataTable = new libraryDataSet1.authorsDataTable();
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
		[global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
		public virtual int Update(libraryDataSet1.authorsDataTable dataTable)
		{
