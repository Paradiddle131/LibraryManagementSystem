...
namespace LibraryManagementSystem.Data.Datasets
{
	...
	public partial class libraryDBDataSet2 : global::System.Data.DataSet
	{
		...
		public partial class BookIssueTableDataTable : global::System.Data.TypedTableBase<BookIssueTableRow>
		{
			...
			[global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
			[global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
			public BookIssueTableRow AddBookIssueTableRow(string StudentName, string Surname, string Book_Name, string Book_Author, System.DateTime Issue_Date, System.DateTime Return_Date)
			{
...
namespace LibraryManagementSystem.Data.Datasets.libraryDBDataSet2TableAdapters
{
	...
	public partial class BookIssueTableTableAdapter : global::System.ComponentModel.Component
	{
		...
		private void InitAdapter()
		{
			...
			this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[BookIssueTable] ([StudentName], [Surname], [Book Name], [Book Author], [Issue Date], [Return Date]) VALUES (@StudentName, @Surname, @Book_Name, @Book_Author, @Issue_Date, @Return_Date);
SELECT ID, StudentName, Surname, [Book Name], [Book Author], [Issue Date], [Return Date] FROM BookIssueTable WHERE (ID = SCOPE_IDENTITY())";
			...
			this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[BookIssueTable] SET [StudentName] = @StudentName, [Surname] = @Surname, [Book Name] = @Book_Name, [Book Author] = @Book_Author, [Issue Date] = @Issue_Date, [Return Date] = @Return_Date WHERE (([ID] = @Original_ID) AND ([StudentName] = @Original_StudentName) AND ([Surname] = @Original_Surname) AND ([Book Name] = @Original_Book_Name) AND ([Book Author] = @Original_Book_Author) AND ([Issue Date] = @Original_Issue_Date) AND ((@IsNull_Return_Date = 1 AND [Return Date] IS NULL) OR ([Return Date] = @Original_Return_Date)));
SELECT ID, StudentName, Surname, [Book Name], [Book Author], [Issue Date], [Return Date] FROM BookIssueTable WHERE (ID = @ID)";
		...
		private void InitCommandCollection()
		{
			...
			this._commandCollection[0].CommandText = "SELECT ID, StudentName, Surname, [Book Name], [Book Author], [Issue Date], [Retur" +
				"n Date] FROM dbo.BookIssueTable";
		...
		public virtual int Fill(libraryDBDataSet2.BookIssueTableDataTable dataTable)
		{
		...
		public virtual libraryDBDataSet2.BookIssueTableDataTable GetData()
		{
			this.Adapter.SelectCommand = this.CommandCollection[0];
			libraryDBDataSet2.BookIssueTableDataTable dataTable = new libraryDBDataSet2.BookIssueTableDataTable();
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
		[global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
		public virtual int Update(libraryDBDataSet2.BookIssueTableDataTable dataTable)
		{
		...
		[global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
		[global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
		public virtual int Update(libraryDBDataSet2 dataSet)
		{
		...
		public virtual int Delete(int Original_ID, string Original_StudentName, string Original_Surname, string Original_Book_Name, string Original_Book_Author, System.DateTime Original_Issue_Date, global::System.Nullable<global::System.DateTime> Original_Return_Date)
		{
		...
		public virtual int Insert(string StudentName, string Surname, string Book_Name, string Book_Author, System.DateTime Issue_Date, global::System.Nullable<global::System.DateTime> Return_Date)
		{
			if ((StudentName == null))
			{
		...
		public virtual int Update(string StudentName, string Surname, string Book_Name, string Book_Author, System.DateTime Issue_Date, global::System.Nullable<global::System.DateTime> Return_Date, int Original_ID, string Original_StudentName, string Original_Surname, string Original_Book_Name, string Original_Book_Author, System.DateTime Original_Issue_Date, global::System.Nullable<global::System.DateTime> Original_Return_Date, int ID)
		{
			if ((StudentName == null))
			{
				throw new global::System.ArgumentNullException("StudentName");
		...
		[global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
		[global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
		public virtual int Update(string StudentName, string Surname, string Book_Name, string Book_Author, System.DateTime Issue_Date, global::System.Nullable<global::System.DateTime> Return_Date, int Original_ID, string Original_StudentName, string Original_Surname, string Original_Book_Name, string Original_Book_Author, System.DateTime Original_Issue_Date, global::System.Nullable<global::System.DateTime> Original_Return_Date)
		{
			return this.Update(StudentName, Surname, Book_Name, Book_Author, Issue_Date, Return_Date, Original_ID, Original_StudentName, Original_Surname, Original_Book_Name, Original_Book_Author, Original_Issue_Date, Original_Return_Date, Original_ID);
		}
	}
